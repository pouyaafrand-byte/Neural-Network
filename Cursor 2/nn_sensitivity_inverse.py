...
def load_data(path):
    ...
    input_cols = ["x1", "x2", "x3", "x4", "x5", "x6", "x7"]
    output_cols = ["fx", "fy", "mz", "q"]
...
def plot_heatmap(matrix, layers_list, neurons_list, title, out_path):
    ...
    ax.set_yticklabels(layers_list, color="#f0f0f0", fontsize=10)
...
def main():
    ...
    out_dir = os.path.join(base_dir, "analysis", "nn_sensitivity_inverse")
